...
checkJSON.addEventListener("click", () => {
  ...
  console.log("jsont 확인 :" , json, typeof json);
  ...
  // 기상청 숴버에 7/12 오후 10시 전국 미세먼지 농도를 JSON으로 받아오기
