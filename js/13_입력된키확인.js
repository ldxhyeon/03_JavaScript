...
document.addEventListener("mousemove", function(e){
  ...
  cursorImage.style.top = `${e.pageY - 40}px`;
});
...
//   if(e.key == 'q') {
//     qkey.style.backgroundColor = '#FC6'; 
//   }

//   if(e.key == 'w') {
//     wkey.style.backgroundColor = '#FC6';
//   }

//   if(e.key == 'e') {
//     ekey.style.backgroundColor = '#FC6';
//   }

//   if(e.key == 'r') {
//     rkey.style.backgroundColor = '#FC6';
//   }
...
//   if(e.key == 'q') {
//     qkey.style.backgroundColor = 'white';
//   }

//   if(e.key == 'w') {
//     wkey.style.backgroundColor = 'white';
//   }

//   if(e.key == 'e') {
//     ekey.style.backgroundColor = 'white';
//   }

//   if(e.key == 'r') {
//     rkey.style.backgroundColor = 'white';
//   }
